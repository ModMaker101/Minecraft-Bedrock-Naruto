...
execute as @e[type=item,name="acacia log"] ~~~ setblock ~~1~ air 0 destroy
execute as @e[type=item,name="dark oak log"] ~~~ setblock ~~1~ air 0 destroy
...
execute as @e[type=item,name="stripped jungle log"] ~~~ setblock ~~1~ air 0 destroy
execute as @e[type=item,name="stripped acacia log"] ~~~ setblock ~~1~ air 0 destroy
execute as @e[type=item,name="stripped dark oak log"] ~~~ setblock ~~1~ air 0 destroy
