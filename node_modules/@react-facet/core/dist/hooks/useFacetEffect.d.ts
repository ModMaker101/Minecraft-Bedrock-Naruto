...
import { Facet, Cleanup, ExtractFacetValues } from '../types';
export declare const createUseFacetEffect: (useHook: typeof useEffect | typeof useLayoutEffect) => <Y extends Facet<unknown>[], T extends [...Y]>(effect: (...args: ExtractFacetValues<T>) => void | Cleanup, dependencies: unknown[], facets: T) => void;
/**
 ...
 */
export declare const useFacetEffect: <Y extends Facet<unknown>[], T extends [...Y]>(effect: (...args: ExtractFacetValues<T>) => void | Cleanup, dependencies: unknown[], facets: T) => void;
