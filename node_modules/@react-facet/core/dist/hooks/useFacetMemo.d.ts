 ...
 */
export declare function useFacetMemo<M, Y extends Facet<unknown>[], T extends [...Y]>(selector: (...args: ExtractFacetValues<T>) => M | NoValue, dependencies: unknown[], facets: T, equalityCheck?: EqualityCheck<M>): Facet<M>;
