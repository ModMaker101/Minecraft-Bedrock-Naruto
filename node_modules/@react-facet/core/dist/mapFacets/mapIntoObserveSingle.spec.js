...
it('checks equality of primitives when passing defaultEqualityCheck', () => {
    ...
    const observe = (0, mapIntoObserveSingle_1.mapIntoObserveSingle)(source, (value) => value, equalityChecks_1.defaultEqualityCheck);
...
it('does not checks equality of primitives by default', () => {
    const source = { observe: jest.fn(), get: jest.fn() };
    const observe = (0, mapIntoObserveSingle_1.mapIntoObserveSingle)(source, (value) => value);
    const listener = jest.fn();
    observe(listener);
    expect(source.observe).toBeCalled();
    // trigger an update and check it was called
...
it('supports custom equality checks', () => {
    ...
    const observe = (0, mapIntoObserveSingle_1.mapIntoObserveSingle)(source, (value) => value, customEqualityCheck);
    const listener = jest.fn();
    observe(listener);
    expect(source.observe).toBeCalled();
...
describe('mapping to NO_VALUE', () => {
    it('stops propagation when no equalityCheck is provided', () => {
        const source = { observe: jest.fn(), get: jest.fn() };
        const observe = (0, mapIntoObserveSingle_1.mapIntoObserveSingle)(source, () => types_1.NO_VALUE);
        const listener = jest.fn();
        observe(listener);
        expect(source.observe).toBeCalled();
    ...
    it('stops propagation when defaultEqualityCheck is provided', () => {
        const source = { observe: jest.fn(), get: jest.fn() };
        const observe = (0, mapIntoObserveSingle_1.mapIntoObserveSingle)(source, () => types_1.NO_VALUE, equalityChecks_1.defaultEqualityCheck);
        const listener = jest.fn();
        observe(listener);
        expect(source.observe).toBeCalled();
        // trigger an update and check listener was NOT called
    ...
    it('stops propagation when a custom equalityCheck is provided', () => {
        ...
        const observe = (0, mapIntoObserveSingle_1.mapIntoObserveSingle)(source, () => types_1.NO_VALUE, customEqualityCheck);
        const listener = jest.fn();
        observe(listener);
        expect(source.observe).toBeCalled();
        // trigger an update and check listener was NOT called
...
//# sourceMappingURL=mapIntoObserveSingle.spec.js.map