export declare type Immutable = boolean | number | string | undefined | null;
export declare type ObjectWithImmutables = Record<string, Immutable>;
 ...
 */
export declare type Value = string | number | boolean | undefined | null | [] | Record<string, any> | bigint;
export declare type ExtractFacetValues<T extends ReadonlyArray<Facet<unknown>>> = {
...
export declare type ExcludeFacetFactory<T> = T extends FacetFactory<any> ? never : T;
export interface Listener<T> {
    (value: T): void;
}
export declare type Unsubscribe = () => void;
export declare type Observe<T> = (listener: Listener<T>) => Unsubscribe;
...
export declare type Setter<V> = (callbackSetter: V | ((previousValue: Option<V>) => Option<V>)) => void;
export declare type Cleanup = Unsubscribe;
export declare type StartSubscription<V> = (update: Update<V>) => Cleanup;
export declare const isFacet: <T>(value: Value | Facet<T>) => value is Facet<T>;
export declare type FacetProp<T extends Value> = Facet<T> | ExcludeFacetFactory<T>;
export interface Effect<T> {
    (value: T): void | Cleanup;
}
export declare const NO_VALUE: unique symbol;
export declare type NoValue = typeof NO_VALUE;
export declare type Option<T> = NoValue | T;
/**
 ...
 */
export declare type Batch = () => void;
/**
 ...
 */
export declare type FacetCSSStyleDeclaration = {
